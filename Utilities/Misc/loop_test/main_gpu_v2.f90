PROGRAM LOOP3D
    ...
    WRITE(FILENAME,'(A,I3,A,I3,A,I3,A)') 'loop3d_',IBAR,'GRID_',NT,'THR_',NUM_TIME_STEPS,'STEPS_GPU_V2.txt'
    ...
    SUBROUTINE LOOP3D_OMP_GPU()
       ...
       !$OMP TARGET TEAMS DISTRIBUTE PARALLEL DO NUM_THREADS(256) COLLAPSE(3)
       DO K=1,KBAR
          DO J=1,JBAR
             DO I=0,IBAR
       ...
       !$OMP TEAMS DISTRIBUTE PARALLEL DO NUM_THREADS(256) COLLAPSE(3)
       DO K=1,KBAR
          DO J=0,JBAR
             DO I=1,IBAR
