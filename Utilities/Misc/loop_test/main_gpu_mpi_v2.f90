PROGRAM LOOP3D
    ...
    ! V2: Flux average computation is performed on the CPU.
    USE OMP_LIB
    IMPLICIT NONE
    include 'mpif.h'
    ! MPI declarations
...
TYPE(EDGE_TYPE), ALLOCATABLE, DIMENSION(:) :: EDGE
    ...
    IF (MY_RANK==0) THEN
        WRITE(FILENAME,'(A,I4,A,I2,A,I4,A)') 'loop3d_',IBAR,'GRID_',NT,'THR_',INT(NUM_TASKS),'RANKS_GPU_MPI_V2.txt'
    ...
    SIM_LOOP: DO ISTEP = 1, NUM_TIME_STEPS
       ...
       !$OMP TARGET UPDATE FROM(FVXP(LOC_MIN_HALO_I:LOC_MAX_I_P1,LOC_MIN_HALO_J:LOC_MAX_J_P1,LOC_MIN_HALO_K:LOC_MAX_K_P1))&
       !$OMP FROM(FVYP(LOC_MIN_HALO_I:LOC_MAX_I_P1,LOC_MIN_HALO_J:LOC_MAX_J_P1,LOC_MIN_HALO_K:LOC_MAX_K_P1))&
       !$OMP FROM(FVZP(LOC_MIN_HALO_I:LOC_MAX_I_P1,LOC_MIN_HALO_J:LOC_MAX_J_P1,LOC_MIN_HALO_K:LOC_MAX_K_P1))
