PROGRAM LOOP3D
    ...
    WRITE(FILENAME,'(A,I3,A,I3,A,I3,A)') 'loop3d_',IBAR,'GRID_',NT,'THR_',NUM_TIME_STEPS,'STEPS_CPU_V2.txt'
    ...
    !$OMP DO SCHEDULE(STATIC) COLLAPSE(3) PRIVATE(WOMY, VOMZ, TXXP, TXXM, DTXXDX, DTXYDY, DTXZDZ)
    DO K=1,KBAR
       DO J=1,JBAR
          DO I=0,IBAR
    ...
    !$OMP DO SCHEDULE(STATIC) COLLAPSE(3) PRIVATE(WOMX, UOMZ, TYYP, TYYM, DTXYDX, DTYYDY, DTYZDZ)
    DO K=1,KBAR
       DO J=0,JBAR
          DO I=1,IBAR
    ...
    !$OMP DO SCHEDULE(STATIC) COLLAPSE(3) PRIVATE(UOMY, VOMX, TZZP, TZZM, DTXZDX, DTYZDY, DTZZDZ)
    DO K=0,KBAR
       DO J=1,JBAR
          DO I=1,IBAR
